...
DATASETS_PATH = {'DTD' : '/home/DATA/datasets/DTD',
                 'FMD' : '/home/DATA/datasets/FMD',
                 'USPtex': '/home/DATA/datasets/USPTex',
                 'LeavesTex1200': '/home/DATA/datasets/LeavesTex1200',
                 'KTH-TIPS2-b': '/home/DATA/datasets/KTH-TIPS2-b',
                 'Outex' : '/home/DATA/datasets/Outex',
                 'MINC': '/home/DATA/datasets/MINC',
                 'GTOS': '/home/DATA/datasets/GTOS',
                 'GTOS-Mobile': '/home/DATA/datasets/GTOS-Mobile'
                }
...
class USPtex(Dataset):
    ...
    """    
    def __init__(self, root=DATASETS_PATH['USPtex'], transform=None, load_all=True, grayscale=False):
        """
        Args:
...
class LeavesTex1200(Dataset):
    ...
    """
    def __init__(self, root=DATASETS_PATH['LeavesTex1200'], transform=None, load_all=True, grayscale=False):
        """
        Args:
            root_dir (string): Directory with all the images.
            transform (callable, optional): Optional transform to be applied
...
class KTH_TIPS2_b(Dataset):
     ...
     """     
     def __init__(self, root=DATASETS_PATH['KTH-TIPS2-b'], transform=None, load_all=True, grayscale=False):
         """
         Args:
...
class FMD(Dataset):
     ...
     """     
     def __init__(self, root=DATASETS_PATH['FMD'], transform=None, load_all=True, grayscale=False):
         """
         Args:
             root_dir (string): Directory with the original dataset.
             transform (callable, optional): Optional transform to be applied
...
class Outex(Dataset):
      ...
      """     
      def __init__(self, root=DATASETS_PATH['Outex'], split=1, suite='13', transform=None, load_all=True, grayscale=False):
          """
          Args:
              root_dir (string): Directory with the original dataset.
...
def GTOS_mobile(root=DATASETS_PATH['GTOS-Mobile'], split='train', transform=None):
    """
...
#%%
class GTOS(Dataset):
    def __init__(self, root=DATASETS_PATH['GTOS'], transform=None, download=False):
